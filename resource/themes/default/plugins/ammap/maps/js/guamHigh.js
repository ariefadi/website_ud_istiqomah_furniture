// (c) ammap.com | SVG (in JSON format) map of Guam - High
// areas: {id:"GU-GU"}
AmCharts.maps.guamHigh={
	"svg": {
		"defs": {
			"amcharts:ammap": {
				"projection":"mercator",
