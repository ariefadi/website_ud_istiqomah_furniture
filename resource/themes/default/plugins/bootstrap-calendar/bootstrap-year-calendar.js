	...
	Calendar.prototype = {
		...
		_initializeOptions: function(opt) {
			...
			this.options = {
				...
				language: (opt.language != null && dates[opt.language] != null) ? opt.language : 'id',
		...
		_applyEvents: function () {
			...
			setInterval(function() {
				...
				if(monthSize * 6 < calendarSize) {
					monthContainerClass += ' col-md-2';
				}
				else if(monthSize * 4 < calendarSize) {
					monthContainerClass += ' col-md-3';
				}
				else if(monthSize * 3 < calendarSize) {
					monthContainerClass += ' col-md-4';
				}
				else if(monthSize * 2 < calendarSize) {
					monthContainerClass += ' col-md-6';
				}
				else {
					monthContainerClass += ' col-md-12';
				}
