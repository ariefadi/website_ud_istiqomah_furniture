<?php /* Smarty version Smarty-3.0.7, created on 2019-02-13 20:22:37
         compiled from "application/views/settings/menu/add.html" */ ?>
<?php /*%%SmartyHeaderCode:16617032675c641a1d1c2198-17062886%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '16617032675c641a1d1c2198-17062886',
  'function' => 
  array (
  ),
...
" class="btn btn-outline btn-default btn-sm"><i class="fa fa-angle-left"></i> Kembali</a>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
        ...
        <form class="form-horizontal" id="addForm" v-on:submit.prevent="addProcess">
          <input type="hidden" v-model="portal.portal_id" name="portal_id" :value="portal.portal_id">
...
,
    ...
    methods:{
      addProcess: function () {
        ...
        http.post('/process_add', formData)
        .then(response => {
          this.loading = false;

          if(response.data.status == 'success'){
            this.input.parent_id = '';
            this.input.nav_title = '';
            this.input.nav_desc = '';
            this.input.nav_url = '';
            this.input.nav_no = '';
            this.input.active_st = '';
            this.input.display_st = '';
            this.input.nav_icon = '';
          }
