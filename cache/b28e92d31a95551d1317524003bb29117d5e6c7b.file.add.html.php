<?php /* Smarty version Smarty-3.0.7, created on 2019-02-13 22:22:45
         compiled from "application/views/settings/roles/add.html" */ ?>
<?php /*%%SmartyHeaderCode:13418566185c643645eff2b1-34960360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b28e92d31a95551d1317524003bb29117d5e6c7b' => 
    array (
      0 => 'application/views/settings/roles/add.html',
      1 => 1548946578,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13418566185c643645eff2b1-34960360',
  'function' => 
  array (
  ),
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        Tambah Data <?php echo $_smarty_tpl->getVariable('page_title')->value;?>
      ...
      addProcess: function () {
        ...
        .then(response => {
          ...
          if(response.data.status == 'success'){
            this.inputs.group_id = '';
            this.inputs.role_nm = '';
            this.inputs.role_desc = '';
            this.inputs.default_page = '';
            this.inputs.portal_id = '';
          }
