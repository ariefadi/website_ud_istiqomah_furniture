<?php /* Smarty version Smarty-3.0.7, created on 2019-05-30 21:51:00
         compiled from "application/views/users/akun/add.html" */ ?>
<?php /*%%SmartyHeaderCode:11889378095cefedd48ba4d6-20915890%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '346284b0bc90191ba6267d5ac9115ecd75492833' => 
    array (
      0 => 'application/views/users/akun/add.html',
      1 => 1554784337,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11889378095cefedd48ba4d6-20915890',
  'function' => 
  array (
  ),
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Nama Lengkap <br>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">NIK (No KTP) <br>
                                                <small class="form-text text-danger">Wajib diisi.</small>
                                            </label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Tempat Lahir <br>
                                                <small class="form-text text-danger">Wajib diisi.</small>
                                            </label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Tanggal Lahir <br>
                                                <small class="form-text text-danger">Wajib diisi.</small>
                                            </label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Jenis Kelamin <br>
                                                <small class="form-text text-danger">Wajib diisi.</small>
                                            </label>
                                            <div class="col-md-8">
                                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Status Perkawinan <br>
                                                <small class="form-text text-danger">Wajib diisi.</small>
                                            </label>
                                            <div class="col-md-8">
                                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Alamat <br>
                                                <small class="form-text text-danger">Wajib Diisi.</small>
                                            </label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">RT/RW <br>
                                                <small class="form-text text-danger">Wajib Diisi.</small>
                                            </label>
                                            <div class="col-md-4">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Pekerjaan <br>
                                                <small class="form-text text-danger">Wajib Diisi.</small>
                                            </label>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <img id="personal-img" class="img-thumbnail" src="" alt="Personal" width="150px">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        onComplete: function(){
            ...
            .then(response => {
                ...
                if(response.data.status == 'success'){
                    ...
                    this.input.status_perkawinan = '';
                    this.input.alamat = '';
                    this.input.rt = '';
                    this.input.rw = '';
                    this.input.pekerjaan = '';
                    this.input.telp = '';
                    this.input.user_mail = '';
                    this.input.user_st = '';
                }
